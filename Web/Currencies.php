...
<body>
<h3 class="container mt-5" style="text-align:center;color:grey">Upload Currencies Details CSV File</h3>
<div class="wrapper">
<div class="container wrapper-form">
    <form action="Curaction.php" method="POST" enctype="multipart/form-data">
